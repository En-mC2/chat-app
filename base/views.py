...
def home(request):
    ...
    return render(request, 'base/home.html',{'rooms':rooms, 'topics':topics,'room_count': room_count,'room_messages':room_messages,'Topics':Topics})
...
def userProfile(request,pk):
    ...
    room_message = Message.objects.filter(user=user)
    context={'user':user,'room_messages':room_message}
...
def topicsPage(request):
    ...
    Topics = Topic.objects.all()
    return render(request,'base/topics.html',{'topics':topics,'Topics':Topics})
